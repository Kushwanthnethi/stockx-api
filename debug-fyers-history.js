...
async function testFyersHistory() {
    ...
    try {
        ...
        console.log('1D History Result:', res1d.s, 'Message:', res1d.message);
        console.log('Candles:', res1d.candles?.length || 0);
        if (res1d.candles && res1d.candles.length > 0) {
            console.log('First candle:', res1d.candles[0]);
            console.log('Last candle:', res1d.candles[res1d.candles.length - 1]);
        }
    } catch (e) {
    ...
    try {
        ...
        console.log('1W History Result:', res1w.s, 'Message:', res1w.message);
        console.log('Candles:', res1w.candles?.length || 0);
    } catch (e) {
